...
```Groovy
implementation 'com.google.cloud:google-cloud-monitoring-dashboard:2.17.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-monitoring-dashboard" % "2.17.0"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-monitoring-dashboard/latest/overview
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-monitoring-dashboard/2.16.0
