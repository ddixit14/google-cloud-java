# Google Cloud Memcache Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-memcache:3.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-memcache" % "3.0.0"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-memcache/latest/overview
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-memcache/2.14.0
