...
<!-- {x-version-update-start:google-cloud-gkehub:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-gkehub:2.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-gkehub" % "2.0.0"
```
