# Google Cloud Domains Client for Java
...
<!-- {x-version-update-start:google-cloud-domains:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-domains:2.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-domains" % "2.0.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-domains/1.11.0
