# Google Storage Transfer Service Client for Java
...
<!-- {x-version-update-start:google-cloud-storage-transfer:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-storage-transfer:1.15.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-storage-transfer" % "1.15.0"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-storage-transfer/latest/overview
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-storage-transfer/1.14.0
