...
<!-- {x-version-update-start:google-cloud-orgpolicy:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-orgpolicy:3.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-orgpolicy" % "3.0.0"
```
...
[product-docs]: n/a
[javadocs]: https://cloud.google.com/java/docs/reference/proto-google-cloud-orgpolicy-v1/latest/overview
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-orgpolicy/2.14.0
