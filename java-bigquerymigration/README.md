# Google BigQuery Migration Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-bigquerymigration:1.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-bigquerymigration" % "1.0.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-bigquerymigration/0.17.0
