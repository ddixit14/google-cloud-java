# Google Datastream Client for Java
...
<!-- {x-version-update-start:google-cloud-datastream:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-datastream:2.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-datastream" % "2.0.0"
```
