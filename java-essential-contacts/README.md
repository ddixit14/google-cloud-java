# Google Essential Contacts API Client for Java
...
<!-- {x-version-update-start:google-cloud-essential-contacts:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-essential-contacts:3.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-essential-contacts" % "3.0.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-essential-contacts/2.14.0
