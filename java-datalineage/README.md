# Google Data Lineage Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-datalineage:1.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-datalineage" % "1.0.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-datalineage/0.6.0
