...
<!-- {x-version-update-start:google-cloud-eventarc-publishing:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-eventarc-publishing:1.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-eventarc-publishing" % "1.0.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-eventarc-publishing/0.14.0
