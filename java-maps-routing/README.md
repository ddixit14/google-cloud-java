...
```Groovy
implementation 'com.google.maps:google-maps-routing:0.10.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.maps" % "google-maps-routing" % "0.10.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.maps/google-maps-routing/1.3.0
