...
<!-- {x-version-update-start:google-cloud-life-sciences:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-life-sciences:1.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-life-sciences" % "1.0.0"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-life-sciences/latest/overview
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-life-sciences/0.16.0
