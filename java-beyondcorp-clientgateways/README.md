# Google BeyondCorp ClientGateways Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-beyondcorp-clientgateways:1.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-beyondcorp-clientgateways" % "1.0.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-beyondcorp-clientgateways/0.12.0
