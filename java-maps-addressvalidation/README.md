# Google Address Validation API Client for Java
...
```Groovy
implementation 'com.google.maps:google-maps-addressvalidation:1.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.maps" % "google-maps-addressvalidation" % "1.0.0"
```
