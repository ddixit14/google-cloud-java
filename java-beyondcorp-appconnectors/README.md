# Google BeyondCorp AppConnectors Client for Java
...
<!-- {x-version-update-start:google-cloud-beyondcorp-appconnectors:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-beyondcorp-appconnectors:1.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-beyondcorp-appconnectors" % "1.0.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-beyondcorp-appconnectors/0.12.0
