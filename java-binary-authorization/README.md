...
```Groovy
implementation 'com.google.cloud:google-cloud-binary-authorization:2.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-binary-authorization" % "2.0.0"
```
...
You'll need to obtain the `google-cloud-binary-authorization` library.  See the [Quickstart](#quickstart) section
to add `google-cloud-binary-authorization` as a dependency in your code.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-binary-authorization/1.13.0
