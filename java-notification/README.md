# Google Google Cloud Pub/Sub Notifications for GCS Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-notification:1.0.0-beta'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-notification" % "1.0.0-beta"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-notification/0.132.0-beta
