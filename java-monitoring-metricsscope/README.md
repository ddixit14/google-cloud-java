# Google Monitoring Metrics Scopes Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-monitoring-metricsscope:1.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-monitoring-metricsscope" % "1.0.0"
```
