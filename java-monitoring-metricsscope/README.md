...
```Groovy
implementation 'com.google.cloud:google-cloud-monitoring-metricsscope:0.9.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-monitoring-metricsscope" % "0.9.0"
```
