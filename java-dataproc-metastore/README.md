# Google Dataproc Metastore Client for Java
...
<!-- {x-version-update-start:google-cloud-dataproc-metastore:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-dataproc-metastore:3.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-dataproc-metastore" % "3.0.0"
```
