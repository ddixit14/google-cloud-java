...
```Groovy
implementation 'com.google.cloud:google-cloud-retail:2.17.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-retail" % "2.17.0"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-retail/latest/overview
