# Google IAM Admin API Client for Java
...
<!-- {x-version-update-start:google-iam-admin:released} -->
...
```Groovy
implementation 'com.google.cloud:google-iam-admin:3.10.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-iam-admin" % "3.10.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-iam-admin/3.9.0
