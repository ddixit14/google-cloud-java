# Google Video Transcoder Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-video-transcoder:1.14.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-video-transcoder" % "1.14.0"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-video-transcoder/latest/overview
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-video-transcoder/1.13.0
