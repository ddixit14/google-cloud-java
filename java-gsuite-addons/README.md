# Google Google Workspace Add-ons API Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-gsuite-addons:3.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-gsuite-addons" % "3.0.0"
```
...
The client application making API calls must be granted [authorization scopes][auth-scopes] required for the desired Google Workspace Add-ons API APIs, and the authenticated principal must have the [IAM role(s)][predefined-iam-roles] required to access GCP resources using the Google Workspace Add-ons API API calls.
...
You will need to [enable billing][enable-billing] to use Google Google Workspace Add-ons API.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-gsuite-addons/2.14.0
...
[enable-api]: https://console.cloud.google.com/flows/enableapi?apiid=gsuiteaddons.googleapis.com
