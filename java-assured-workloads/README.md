# Google Assured Workloads for Government Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-assured-workloads:3.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-assured-workloads" % "3.0.0"
```
...
The client application making API calls must be granted [authorization scopes][auth-scopes] required for the desired Assured Workloads for Government APIs, and the authenticated principal must have the [IAM role(s)][predefined-iam-roles] required to access GCP resources using the Assured Workloads for Government API calls.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-assured-workloads/2.14.0
