# Google Video Stitcher API Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-video-stitcher:1.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-video-stitcher" % "1.0.0"
```
