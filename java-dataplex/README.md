# Google Cloud Dataplex Client for Java
...
<!-- {x-version-update-start:google-cloud-dataplex:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-dataplex:2.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-dataplex" % "2.0.0"
```
