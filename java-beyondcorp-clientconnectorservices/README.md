# Google BeyondCorp ClientConnectorServices Client for Java
...
<!-- {x-version-update-start:google-cloud-beyondcorp-clientconnectorservices:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-beyondcorp-clientconnectorservices:1.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-beyondcorp-clientconnectorservices" % "1.0.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-beyondcorp-clientconnectorservices/0.12.0
