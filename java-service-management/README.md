# Google Service Management API Client for Java
...
<!-- {x-version-update-start:google-cloud-service-management:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-service-management:3.13.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-service-management" % "3.13.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-service-management/3.12.0
