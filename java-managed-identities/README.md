# Google Managed Service for Microsoft Active Directory Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-managed-identities:2.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-managed-identities" % "2.0.0"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-managed-identities/latest/overview
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-managed-identities/1.12.0
