...
<!-- {x-version-update-start:google-cloud-eventarc:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-eventarc:2.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-eventarc" % "2.0.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-eventarc/1.14.0
