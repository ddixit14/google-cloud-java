# Google Connect Gateway API Client for Java
...
<!-- {x-version-update-start:google-cloud-gke-connect-gateway:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-gke-connect-gateway:1.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-gke-connect-gateway" % "1.0.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-gke-connect-gateway/0.15.0
